...
export const Login: React.FC = () => {
  ...
  const portals: PortalConfig[] = [
    ...
    },
    {
      ...
      icon: <HeartHandshake className="w-4 h-4 text-green-600 dark:text-green-400" />,
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/90 dark:border-slate-800 shadow-xl p-6 sm:p-10 space-y-8 relative">
      ...
      {redirectingMessage && (
        <div className="absolute inset-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xs rounded-3xl flex flex-col items-center justify-center p-6 text-center space-y-4">
          <div className="w-14 h-14 rounded-full bg-brand-50 dark:bg-brand-950/60 flex items-center justify-center">
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full py-3 px-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-750 text-slate-800 dark:text-white font-semibold text-sm rounded-xl border border-slate-300 dark:border-slate-700 shadow-xs flex items-center justify-center gap-3 transition-all hover:shadow-md disabled:opacity-50 cursor-pointer"
        >
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="bg-white dark:bg-slate-900 px-3 text-xs font-medium text-slate-400 uppercase tracking-wider absolute">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between text-xs pt-1">
          ...
          <a href="#forgot" className="font-semibold text-brand-600 hover:text-brand-700 dark:text-brand-400">
            Forgot password?
          </a>
        </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-5 border-t border-slate-100 dark:border-slate-800 text-xs text-slate-500">
        <div>
