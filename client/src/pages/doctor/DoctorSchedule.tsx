      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-4 flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center">{item.icon}</div>
            <div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold border transition-all ${
                workingDays.includes(day)
                  ...
                  : 'bg-slate-50 dark:bg-slate-900 text-slate-500 border-slate-200 dark:border-slate-700 hover:border-teal-300'
              }`}
            >
              {day.slice(0, 3)}
            </button>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative w-11 h-6 rounded-full transition-colors ${teleconsultAvail ? 'bg-teal-500' : 'bg-slate-200 dark:bg-slate-700'}`}
          >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl text-xs font-bold border transition-all ${
                      teleconsultDays.includes(day)
                        ...
                        : 'bg-slate-50 dark:bg-slate-900 text-slate-500 border-slate-200 dark:border-slate-700 hover:border-blue-300'
                    }`}
                  >
                    {day.slice(0, 3)}
                  </button>
