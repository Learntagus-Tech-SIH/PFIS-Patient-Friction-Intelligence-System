      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {referrals.map((ref: any) => {
            ...
            return (
              <div key={id} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm p-5 space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-slate-900 dark:text-white text-sm">{ref.patientName ?? ref.patient_name}</p>
                ...
                <div className="flex items-center gap-1">
                  {STATUS_STEPS.map((step, i) => (
                    <React.Fragment key={step}>
                      <div className={`flex-1 h-1.5 rounded-full transition-all ${i <= stepIdx ? 'bg-teal-500' : 'bg-slate-200 dark:bg-slate-700'}`} />
