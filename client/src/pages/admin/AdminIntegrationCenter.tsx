    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-2xl bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800/50 flex items-start gap-3">
        ...
        <div className="text-xs">
          ...
          <div className="text-indigo-700/80 dark:text-indigo-400/80 mt-0.5">
          ...
          >
            ...
            <div className="space-y-2 pt-3 border-t border-slate-100 dark:border-slate-800 text-xs">
              <div className="flex justify-between text-slate-500">
                ...
                <span className="font-semibold text-slate-700 dark:text-slate-300">{item.authType}</span>
              </div>
              <div className="flex justify-between text-slate-500">
                <span>Sync Cadence:</span>
                <span className="font-semibold text-slate-700 dark:text-slate-300">{item.syncInterval}</span>
              </div>
