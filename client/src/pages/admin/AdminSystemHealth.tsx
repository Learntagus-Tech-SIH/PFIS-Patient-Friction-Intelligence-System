      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
            ...
            <div key={idx} className="p-4 hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <div className="flex items-center gap-4 text-xs text-slate-400 mt-1">
                  <span>Latency: <strong className="text-slate-700 dark:text-slate-300">{sub.latency}</strong></span>
                  <span>•</span>
                  <span>Uptime: <strong className="text-slate-700 dark:text-slate-300">{sub.uptime}</strong></span>
                  <span>•</span>
                  <span>RAM: <strong className="text-slate-700 dark:text-slate-300">{sub.memory}</strong></span>
                </div>
              </div>
