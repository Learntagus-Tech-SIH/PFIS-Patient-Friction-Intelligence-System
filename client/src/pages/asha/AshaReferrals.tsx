            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <strong className="text-sm text-slate-900 dark:text-white">{r.patientName}</strong>
                  <span
              ...
              {/* Transit Pathway */}
              <div className="p-3 bg-slate-50 dark:bg-slate-900 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs">
                <div className="space-y-0.5">
                  <span className="text-[10px] text-slate-400 uppercase font-semibold">Origin Facility</span>
                  <p className="font-semibold text-slate-800 dark:text-slate-200">{r.fromFacilityName}</p>
                </div>
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="font-semibold text-teal-700 dark:text-teal-300">{r.toFacilityName}</p>
                </div>
                <div className="space-y-0.5">
                  <span className="text-[10px] text-slate-400 uppercase font-semibold">Specialty Required</span>
                  <p className="font-semibold text-slate-800 dark:text-slate-200">{r.specialtyRequired}</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-slate-100 dark:border-slate-700 text-[11px] text-slate-400">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-lg w-full p-6 shadow-2xl space-y-4 animate-scale-in">
            ...
            <form onSubmit={handleNavigationSubmit} className="space-y-3 text-xs">
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Transport Arrangement</label>
                <select
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Referral Status Update</label>
                  <select
                    value={newStatus}
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Navigation Assistance Notes</label>
                <textarea
                  rows={3}
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-900 rounded-xl text-[11px] text-slate-500 border border-slate-200">
