        ...
        <div className="flex items-center gap-2">
          {queue.length > 0 && (
            <button
              ...
              className="px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 text-slate-600 text-xs font-semibold"
            >
              Clear Local Log
            </button>
          )}
          ...
          <div className="space-y-3">
            {queue.map((op) => (
              <div
                ...
                className="p-3.5 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs font-mono"
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <strong className="text-slate-900 dark:text-white">{op.operationType}</strong>
                    <span
