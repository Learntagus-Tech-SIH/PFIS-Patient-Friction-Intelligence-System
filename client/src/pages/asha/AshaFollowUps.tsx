            ...
            >
              <div className="space-y-1.5">
                <div className="flex flex-wrap items-center gap-2">
                  <strong className="text-sm text-slate-900 dark:text-white">{t.patientName}</strong>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-md w-full p-6 shadow-2xl space-y-4 animate-scale-in">
            ...
            <form onSubmit={handleUpdateStatus} className="space-y-3 text-xs">
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Outreach Outcome Notes</label>
                <textarea
                  rows={3}
                  value={taskOutcome}
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-md w-full p-6 shadow-2xl space-y-4 animate-scale-in">
            ...
            <form onSubmit={handleCreateTask} className="space-y-3 text-xs">
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Task Instructions</label>
                <textarea
                  rows={2}
