    ...
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 text-xs">
          {/* Question 1 */}
          <div className="p-3.5 bg-teal-50/70 dark:bg-teal-950/30 rounded-xl border border-teal-200 dark:border-teal-800/50 space-y-1">
            <span className="text-slate-500 dark:text-slate-400 block font-medium">1. Visits Today</span>
            <strong className="text-lg font-bold text-teal-800 dark:text-teal-200 block">
              {stats?.todayVisitsCount ?? todayVisits.length} Assigned
            </strong>
            <span className="text-teal-700 dark:text-teal-300 text-[11px] block">
              {stats?.completedVisitsCount ?? 1} Done • {stats?.inProgressVisitsCount ?? 1} In Progress
            </span>
          </div>

          {/* Question 2 */}
          <div className="p-3.5 bg-amber-50/70 dark:bg-amber-950/30 rounded-xl border border-amber-200 dark:border-amber-800/50 space-y-1">
            <span className="text-slate-500 dark:text-slate-400 block font-medium">2. Patients Needing Follow-up</span>
            <strong className="text-lg font-bold text-amber-800 dark:text-amber-200 block">
              {stats?.followUpTasksCount ?? pendingTasks.length} Beneficiaries
            </strong>
            <span className="text-amber-700 dark:text-amber-300 text-[11px] block">
              Doorstep vitals & NCD reminders
            </span>
          </div>

          {/* Question 3 */}
          <div className="p-3.5 bg-blue-50/70 dark:bg-blue-950/30 rounded-xl border border-blue-200 dark:border-blue-800/50 space-y-1">
            <span className="text-slate-500 dark:text-slate-400 block font-medium">3. Pending Referrals</span>
            <strong className="text-lg font-bold text-blue-800 dark:text-blue-200 block">
              {stats?.pendingReferralsCount ?? pendingReferrals.length} Cases
            </strong>
            <span className="text-blue-700 dark:text-blue-300 text-[11px] block">
              Require transit & booking aid
            </span>
          </div>

          {/* Question 4 */}
          <div className="p-3.5 bg-rose-50/70 dark:bg-rose-950/30 rounded-xl border border-rose-200 dark:border-rose-800/50 space-y-1">
            <span className="text-slate-500 dark:text-slate-400 block font-medium">4. Access Barriers</span>
            <strong className="text-lg font-bold text-rose-800 dark:text-rose-200 block">
          ...
          <div className="p-3.5 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 space-y-1">
            <span className="text-slate-500 dark:text-slate-400 block font-medium">5. Sync Queue</span>
            <strong className="text-lg font-bold text-slate-800 dark:text-slate-200 block">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Visits Card */}
        <div className="lg:col-span-2 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm space-y-5">
          <div className="flex items-center justify-between">
          ...
          {todayVisits.length === 0 ? (
            <div className="p-8 text-center text-slate-500 text-xs bg-slate-50 dark:bg-slate-900 rounded-xl">
            ...
            <div className="space-y-3">
              {todayVisits.map((v) => (
                <div
                  key={v.id}
                  className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-900/50 flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                >
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      <strong className="text-sm text-slate-900 dark:text-white">{v.patientName}</strong>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm space-y-5">
          ...
          <div className="space-y-3 text-xs">
            ...
            <div className="p-3 bg-blue-50/60 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 rounded-xl space-y-1.5">
            ...
            <div className="p-3 bg-teal-50/60 dark:bg-teal-950/20 border border-teal-200 dark:border-teal-900 rounded-xl space-y-1.5">
            ...
            <div className="p-3 bg-rose-50/60 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900 rounded-xl space-y-1.5">
            ...
            <div className="p-3 bg-amber-50/60 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900 rounded-xl space-y-1.5">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-xs">
          <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 text-center space-y-1">
