          ...
          >
            <div className="space-y-1">
              <div className="flex flex-wrap items-center gap-2">
                <strong className="text-sm text-slate-900 dark:text-white">{doc.patientName}</strong>
            ...
            <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
              <button
                ...
                className="px-3.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 hover:bg-slate-50 text-slate-700 dark:text-slate-200 font-bold text-xs shadow-sm"
              >
                View Details
              </button>
            </div>
