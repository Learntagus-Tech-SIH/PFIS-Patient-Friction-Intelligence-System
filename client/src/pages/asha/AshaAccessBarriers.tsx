...
export const AshaAccessBarriers: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="p-4 bg-teal-50/70 dark:bg-teal-950/30 border border-teal-200 dark:border-teal-800 rounded-2xl flex items-center gap-3 text-xs text-teal-900 dark:text-teal-200">
      ...
      <div className="space-y-3">
        {isLoading ? (
          ...
          filtered.map((b: any) => (
            <div
              key={b.id}
              className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm space-y-3 hover:border-teal-300 transition-all"
            >
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="p-1.5 rounded-lg bg-slate-100 dark:bg-slate-900">
                  ...
                  <strong className="text-sm text-slate-900 dark:text-white">{b.patientName}</strong>
              ...
              {b.actionTaken && (
                <div className="p-2.5 bg-slate-50 dark:bg-slate-900 rounded-xl text-[11px] text-teal-800 dark:text-teal-200 font-medium">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-md w-full p-6 shadow-2xl space-y-4 animate-scale-in">
            ...
            <form onSubmit={handleRecordSubmit} className="space-y-3 text-xs">
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Barrier Category</label>
                <select
                  value={category}
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Barrier Description</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Additional Observations / Context</label>
                <textarea
                  rows={2}
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Immediate Action Plan / Mitigation</label>
                <input
                  type="text"
