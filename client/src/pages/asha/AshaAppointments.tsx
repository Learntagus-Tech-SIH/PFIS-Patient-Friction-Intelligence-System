      ...
      <div className="space-y-3">
        {isLoading ? (
          ...
          appointments.map((apt: any) => (
            <div
              key={apt.id}
              className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm space-y-2 hover:border-teal-300 transition-all"
            >
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-lg w-full p-6 shadow-2xl space-y-4 animate-scale-in">
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Health Facility</label>
                  <select
                    value={hospitalName}
