        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-lg w-full p-6 shadow-2xl space-y-4 animate-scale-in">
            ...
            <form onSubmit={handleCompleteSubmit} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    ...
                    className="flex-grow p-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl"
                  />
                  <button
                    type="button"
                    onClick={handleAddBarrier}
                    className="px-3.5 py-2 bg-slate-200 dark:bg-slate-700 rounded-xl font-bold text-slate-700 dark:text-slate-200"
                  >
                    Add
                  </button>
                </div>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 text-[11px] text-slate-500">
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 max-w-md w-full p-6 shadow-2xl space-y-4 animate-scale-in">
            ...
            <form onSubmit={handleScheduleSubmit} className="space-y-3 text-xs">
              ...
              <div>
                <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Scheduled Date / Time</label>
                <input
                  type="text"
