...
export const AshaSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
            ...
            <button
              ...
              className={`p-3.5 rounded-xl border text-left transition-all ${
                i18n.language === lang.id
                  ? 'border-teal-500 bg-teal-50 dark:bg-teal-950/40 text-teal-900 dark:text-teal-200 font-bold shadow-sm'
      ...
      {/* Profile Form */}
      <form onSubmit={handleSave} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm space-y-5 text-xs">
        <div className="flex items-center gap-2.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Official Full Name</label>
            <input
              type="text"
              value={profile?.name || 'Kavita Devi'}
              disabled
              className="w-full p-2.5 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl font-semibold text-slate-500"
            />
          </div>
          <div>
            <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Worker Mobile Phone</label>
            <input
              type="text"
              value={phone}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Sub-centre</label>
            <input
              type="text"
              value={subCentre}
          ...
          <div>
            <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Primary Health Centre (PHC)</label>
            <input
              type="text"
              value={phc}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div>
            <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Block</label>
            <input
              type="text"
              value={block}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">ANM Supervisor Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Supervisor Phone</label>
            <input
              type="text"
