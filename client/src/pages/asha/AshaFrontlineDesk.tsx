  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Link
          to="/asha/opd-tokens"
          className="p-5 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:border-teal-400 hover:shadow-md transition-all group text-left space-y-2"
        >
          <div className="p-3 bg-teal-50 dark:bg-teal-950/40 text-teal-600 rounded-xl w-fit group-hover:scale-110 transition-transform">
            <Ticket className="w-5 h-5" />
          </div>
          <div>
            <strong className="text-sm text-slate-900 dark:text-white block">Generate OPD Token</strong>
        ...
        <Link
          ...
          className="p-5 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:border-teal-400 hover:shadow-md transition-all group text-left space-y-2"
        >
          <div className="p-3 bg-blue-50 dark:bg-blue-950/40 text-blue-600 rounded-xl w-fit group-hover:scale-110 transition-transform">
            <Clock className="w-5 h-5" />
          </div>
          <div>
            <strong className="text-sm text-slate-900 dark:text-white block">Book Appointment</strong>
        ...
        <Link
          ...
          className="p-5 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:border-teal-400 hover:shadow-md transition-all group text-left space-y-2"
        >
          <div className="p-3 bg-amber-50 dark:bg-amber-950/40 text-amber-600 rounded-xl w-fit group-hover:scale-110 transition-transform">
            <ShieldAlert className="w-5 h-5" />
          </div>
          <div>
            <strong className="text-sm text-slate-900 dark:text-white block">Record Access Barrier</strong>
        ...
        <Link
          ...
          className="p-5 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm hover:border-teal-400 hover:shadow-md transition-all group text-left space-y-2"
        >
          <div className="p-3 bg-purple-50 dark:bg-purple-950/40 text-purple-600 rounded-xl w-fit group-hover:scale-110 transition-transform">
            <GitFork className="w-5 h-5" />
          </div>
          <div>
            <strong className="text-sm text-slate-900 dark:text-white block">Referral Navigator</strong>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            {tasks.slice(0, 4).map((t) => (
              <div
                key={t.id}
                className="p-3.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 flex items-center justify-between gap-3 text-xs"
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    <strong className="text-slate-900 dark:text-white">{t.patientName}</strong>
                    <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-amber-100 text-amber-800">
                      {t.priority || 'Medium'}
                    </span>
                  </div>
                  <p className="text-slate-600 dark:text-slate-400">{t.taskType}</p>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm space-y-4">
          ...
          <div className="space-y-3 text-xs text-slate-600 dark:text-slate-300">
            <div className="p-3 bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-900 rounded-xl space-y-1">
            ...
            <div className="p-3 bg-rose-50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900 rounded-xl space-y-1">
              <strong className="text-rose-900 dark:text-rose-200 block font-bold">
