      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-amber-50 text-amber-700 dark:bg-amber-950/50 dark:text-amber-300 border border-amber-200 dark:border-amber-800">
            ...
            <div key={idx} className="p-4 hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-4 text-xs text-slate-400">
                  <span>Current Queue: <strong className="text-slate-700 dark:text-slate-300">{dep.activeQueue} tokens</strong></span>
                  <span>•</span>
                  <span>Clearance: <strong className="text-slate-700 dark:text-slate-300">{dep.throughputPerHour} pts/hr</strong></span>
                </div>
              </div>
