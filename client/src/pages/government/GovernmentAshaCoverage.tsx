      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-pink-50 text-pink-700 dark:bg-pink-950/50 dark:text-pink-300 border border-pink-200 dark:border-pink-800">
            ...
            <div key={idx} className="p-4 hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <div className="flex items-center gap-4 text-xs text-slate-400 mt-1">
                  <span>Frontline Staff: <strong className="text-slate-700 dark:text-slate-300">{sec.activeWorkers} ASHAs</strong></span>
                  <span>•</span>
                  <span>Households: <strong className="text-slate-700 dark:text-slate-300">{sec.households}</strong></span>
                  <span>•</span>
