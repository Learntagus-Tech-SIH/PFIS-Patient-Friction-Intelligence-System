      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
          <div className="flex items-center gap-2">
            <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-teal-50 text-teal-700 dark:bg-teal-950/50 dark:text-teal-300 border border-teal-200 dark:border-teal-800">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
        ...
        <div className="divide-y divide-slate-100 dark:divide-slate-800">
          {labs.map((lab: any, idx: number) => (
            <div key={idx} className="p-4 hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="space-y-1">
                <div className="font-bold text-sm text-slate-900 dark:text-white">
                  {lab.name}
                </div>
                <div className="flex items-center gap-4 text-xs text-slate-400">
                  <span>District: <strong className="text-slate-700 dark:text-slate-300">{lab.district}</strong></span>
                  <span>•</span>
                  <span>Tests Today: <strong className="text-slate-700 dark:text-slate-300">{lab.testsToday}</strong></span>
                  <span>•</span>
                  <span>Pending: <strong className="text-slate-700 dark:text-slate-300">{lab.pendingResults}</strong></span>
                </div>
              </div>
